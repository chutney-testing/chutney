...
class HttpScenarioTest {
    ...
    private val wireMockContainer = WireMockContainer(DockerImageName.parse("wiremock/wiremock:2.35.0"))
        .withMappingFromResource("wiremock-testcontainer/create-&-update-film/post_film.json")
        .withMappingFromResource("wiremock-testcontainer/create-&-update-film/patch_film.json")
        .withMappingFromResource("wiremock-testcontainer/create-&-update-film/get_film.json")

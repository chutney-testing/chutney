...
public class JsonCompareActionTest {
    ...
    void documents_must_not_be_blanks(String doc1) {
        ...
        JsonCompareAction jsonAssertAction = new JsonCompareAction(mock(Logger.class), doc1, doc1, null, null);
        List<String> errors = jsonAssertAction.validateInputs();
    ...
    void should_compare_documents_roots_by_default(Map<String, String> paths) {
        ...
        JsonCompareAction jsonAssertAction = new JsonCompareAction(mock, doc1, doc1, paths, null);
    ...
    void should_execute_2_successful_assertions_on_comparing_actual_result_to_expected() {
        ...
        // When
        JsonCompareAction jsonAssertAction = new JsonCompareAction(mock(Logger.class), doc1, doc2, pathInputs, null);
        ActionExecutionResult result = jsonAssertAction.execute();
    ...
    void should_failed_on_bad_assertions() {
        ...
        // When
        JsonCompareAction jsonAssertAction = new JsonCompareAction(mockLogger, doc1, doc2, pathInputs, null);
        ActionExecutionResult result = jsonAssertAction.execute();
    ...
    class LenientComparison {
        ...
        void lenient_should_be_ok_for_strict_json_equal(String doc) {
            // When
            Logger mock = mock(Logger.class);
            JsonCompareAction jsonAssertAction = new JsonCompareAction(mock, doc, doc, null, "lenient");
            ActionExecutionResult result = jsonAssertAction.execute();
        ...
        void lenient_should_be_ok_with_extra_attributes_for_one_document_only(String doc1, String doc2, ActionExecutionResult.Status expectedStatus) {
            // When
            Logger mock = mock(Logger.class);
            JsonCompareAction jsonAssertAction = new JsonCompareAction(mock, doc1, doc2, null, "LeNiEnT");
            ActionExecutionResult result = jsonAssertAction.execute();
        ...
        void lenient_should_be_ok_with_different_array_order(String doc1, String doc2, ActionExecutionResult.Status expectedStatus) {
            // When
            Logger mock = mock(Logger.class);
            JsonCompareAction jsonAssertAction = new JsonCompareAction(mock, doc1, doc2, null, "LENIENT");
            ActionExecutionResult result = jsonAssertAction.execute();
